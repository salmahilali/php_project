...
<head>
  ...
  * {box-sizing:border-box;margin:0;padding:0}
  body {
    ...
    color: var(--c-white);
    background: 
      linear-gradient(#1f1838a9, #1f1838a9),
      url("dino/bg1.png") no-repeat center center / cover;
    min-height: 100vh;
    display: flex;
  ...
  .hole {
    ...
    background: var(--c-bg-light);
    border-radius: 50%;
    box-shadow: inset 0 3px 5px rgba(109, 223, 233, 0.4), var(--shadow);
    cursor: pointer;
    overflow: hidden;
  }
  .hole.mole svg {
  ...
  .overlay {
    ...
    background: rgba(180, 152, 152, 0.55);
    visibility: hidden;
    opacity: 0;
...
<body>
  ...
  <main>
    <section id="grid" class="grid" aria-label="Zone de jeu">
